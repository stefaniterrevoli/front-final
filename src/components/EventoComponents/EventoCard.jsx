const EventoCard = ({ evento, onClick }) => {
  return (
    <div
      className="bg-yellow-100 rounded-xl overflow-hidden border border-purple-800 hover:border-pink-700 transition-all cursor-pointer group"
    ...
    >
      ...
      <div className="p-4">
        <h3 className=" font-titulos text-black font-bold text-lg">
          {evento.title}
        </h3>
